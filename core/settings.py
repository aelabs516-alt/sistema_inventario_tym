...
# Apuntamos a la carpeta public en la misma raíz para que sirva el Frontend
STATICFILES_DIRS = [
    BASE_DIR / 'public',
]

# Le decimos a Whitenoise que sirva los archivos de la carpeta public en la raíz (ej: /index.html)
